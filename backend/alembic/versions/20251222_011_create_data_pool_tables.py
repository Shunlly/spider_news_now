...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('created_by', CHAR(36), nullable=True, comment='创建者用户ID'),
    ...
    op.create_table(
        'article_contents',
        sa.Column('id', CHAR(36), primary_key=True),
        sa.Column('pointer_id', CHAR(36), nullable=False, comment='数据指针ID'),
    ...
    op.create_table(
        'user_data_relations',
        sa.Column('id', CHAR(36), primary_key=True),
        sa.Column('user_id', CHAR(36), nullable=False, comment='用户ID'),
        sa.Column('pointer_id', CHAR(36), nullable=False, comment='数据指针ID'),
