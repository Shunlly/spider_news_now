...
import { scraperService, type ScraperStatus } from '@/services'
...
export default function DashboardPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      let totalArticles = 0
      let todayArticles = 0
      statusResponse.scrapers.forEach((scraper) => {
        if (scraper.last_run) {
          todayArticles += scraper.last_run.articles_new
          totalArticles += scraper.last_run.articles_scraped
        }
      })
