...
def upgrade() -> None:
    ...
    if not column_exists('news_articles', 'user_id'):
        ...
        op.alter_column('news_articles', 'user_id', existing_type=sa.Integer(), nullable=False)
    else:
    ...
    if not column_exists('social_sessions', 'user_id'):
        ...
        op.alter_column('social_sessions', 'user_id', existing_type=sa.Integer(), nullable=False)
    else:
